...
To additionally restrict the local timeline to accounts of the domain the request was made to, set `separate_timelines`:

```elixir
config :pleroma, :instance, multitenancy: [enabled: true, separate_timelines: true]
```
