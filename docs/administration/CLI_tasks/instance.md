...
- `--strip-uploads-location <Y|N>` - strip uploads of sensitive location data
- `--read-uploads-description <Y|N>` - read image descriptions from uploads so clients can prefill the media description field
